<div>
    <div class="w-2/3 p-5 mt-5 mx-auto bg-white rounded-lg">
        <div class="w-3/5 p-5 m-3 bg-white">
            <h1 class="text-orange-300">Friends requests</h1>
                ...
                @foreach ($user->friendOfRequested as $friend)
                    <ul class="flex flex-col m-3">
                        <li class="flex flex-row">
                            <div
                                class="flex items-center transition duration-500 ease-in-out justify-around transform hover:-translate-y-2 rounded-2xl border-2 p-3 w-full hover:shadow-2xl border-orange-300">
