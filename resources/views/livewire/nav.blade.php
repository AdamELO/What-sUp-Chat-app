<nav class="bg-gray-900 sm:flex sm:justify-between sm:items-center sm:px-4 sm:py-3">
    ...
    <ul id="respMenu" class="px-2 pt-2 pb-4 sm:flex sm:p-0 hidden">
        <li>
            <a href="/"
                class="block px-2 py-1 text-white font-semibold rounded hover:text-blue-200 cursor-pointer">Home</a>
        </li>
        @auth
            <li>
                <a href="/dashboard"
                    class="block px-2 py-1 text-white font-semibold rounded hover:text-blue-200 cursor-pointer">Dashboard</a>
            </li>
            @livewire('logout')
        @endauth
        @guest
            <li>
                <a href="/login"
                    class="block px-2 py-1 text-white font-semibold rounded hover:text-blue-200 cursor-pointer">Login</a>
            </li>
            <li>
                <a href="/register"
                    class="block px-2 py-1 text-white font-semibold rounded hover:text-blue-200 cursor-pointer">Register</a>
            </li>
        @endguest
    </ul>
</nav>
